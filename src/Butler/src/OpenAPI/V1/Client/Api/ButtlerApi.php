 ...
 *
 * @category Class
 * @package  Butler\OpenAPI\V1\Client
...
namespace Butler\OpenAPI\V1\Client\Api;
...
use Butler\OpenAPI\V1\Client\Configuration;
use OpenAPI\Client\HeaderSelector;
use OpenAPI\Client\ObjectSerializer;
use Psr\Log\LoggerInterface;

/**
 * ButtlerApi Class Doc Comment
 *
 * @category Class
 * @package  Butler\OpenAPI\V1\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ButtlerApi implements ApiInterface
{
    public const CONFIGURATION_CLASS = 'Butler\OpenAPI\V1\Client\Configuration';
    ...
    {
        list($response) = $this->greetRequesterWithHttpInfo($name);
        return $response;
    }

    /**
     * Operation greetRequesterWithHttpInfo
     *
     ...
     * @return array
     */
    public function greetRequesterWithHttpInfo($name)
    {
        $request = $this->greetRequesterRequest($name);
     ...
     */
    public function greetRequesterAsync($name)
    {
        return $this->greetRequesterAsyncWithHttpInfo($name)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation greetRequesterAsyncWithHttpInfo
     *
     * 
     *
     * @param mixed $name (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function greetRequesterAsyncWithHttpInfo($name)
    {
        $request = $this->greetRequesterRequest($name);
    ...
    /**
     * Create request for operation 'greetRequester'
     *
     * @param mixed $name (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function greetRequesterRequest($name)
    {
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $name when calling greetRequester'
            );
        }
